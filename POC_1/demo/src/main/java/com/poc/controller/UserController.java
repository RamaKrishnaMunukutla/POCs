...
public class UserController {
	...
	public ResponseEntity<Object> createUser(@RequestBody User user) throws BusinessException {
		try {
			...
			BusinessException b = new BusinessException("duplicates are not alllowed");
			errorResponse.setStatusMessage(b.getMessage());
			errorResponse.setStatusCode("422");
			return new ResponseEntity<Object>(errorResponse, HttpStatus.UNPROCESSABLE_ENTITY);
		}
	}
