...
public class ExcelHelper {
	...
	static String[] HEADERs = {"id","availability","country","experience","job_description",
			                   "job_title","job_type","language",
		                    	"pay_rate","reply_rate","skills","state","user_info_id"};
	...
	public static List<com.example.demo.entity.Job> excelToTutorials(InputStream is) {
		try {
			...
			List<com.example.demo.entity.Job> jobs = new ArrayList<>();
			...
			while (rows.hasNext()) {
				...
				com.example.demo.entity.Job job = new com.example.demo.entity.Job();
